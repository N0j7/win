    ...
    <img src="images/death.jpg" alt="">
      ...
      <h3> للدخول في السحب اتبع ما يلي : </h3>
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">بث</li>
            <li class="list-group-item">ساعه</li>
            <li class="list-group-item">نهايه</li>
            <li class="list-group-item">برنامج</li>
        </ul>
      </div>
</div>
    ...
    <div class="col-md-5 p-lg-5 mx-auto my-5">
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="firstName" id="fristName" class="form-control" value="<?php echo $firstName ?>">
